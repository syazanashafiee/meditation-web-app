...
if(isset($_POST['add_library'])){
   ...
   $insert_query = mysqli_query($connect, "INSERT INTO `library`(name, video, description) VALUES('$l_name','$l_video', '$l_description')") or die('query failed');
...
if(isset($_POST['update_library'])){
   ...
   $update_query = mysqli_query($connect, "UPDATE `library` SET name = '$update_l_name', video = '$update_l_video', description = '$update_l_description' WHERE id = '$update_l_id'");
...
<img src="images/kk.png" width="60" height="60" alt="meditation"/>
      ...
      <nav class="navbar">
           ...
           <a href="http://localhost/meditation/admin_guidedmeditation.php">Guided </a>
					...
					<a href="http://localhost/meditation/library.php">LIBRARY</a>
